...
import day14.studentManagement.controller.ClassController;
import day14.studentManagement.model.dto.ClassDto;
...
public class ClassView {
	...
	public void create() { System.out.println("== 등록 ==");
		// [1] 저장할 게시물 정보를 입력
		System.out.print("수업번호 입력 : ");		int code = scan.nextInt();
		System.out.print("수업명 입력 : ");		String name = scan.next();
		System.out.print("강사명 입력 : ");	String teacher = scan.next();
	...
	public void update() { System.out.println("== 수정 ==");
		...
		System.out.print("수업번호 입력 : "); 	int uCode = scan.nextInt();
		System.out.print("수업명 입력 : ");		String name = scan.next();
		System.out.print("강사명 입력 : ");		String teacher = scan.next();
	...
	public void delete() { System.out.println("== 삭제 ==");
		// [1] 삭제할 수업번호 입력받기
		System.out.print("삭제할 수업번호를 입력해주세요. : "); int dCode = scan.nextInt();
